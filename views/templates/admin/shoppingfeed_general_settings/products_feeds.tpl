...
{else if $percent_preloading < 99}
    ...
    <div class="alert alert-danger">
        ...
        {l s='To indexed missing products, please launch manually or set on your server the following task: "Synchronize products on Shopping Feed" available on' mod='shoppingfeed'} <a href="{$link->getAdminLink('AdminShoppingfeedProcessMonitor', true)|escape:'html':'UTF-8'}">{l s='"Logs & Crons" pages' mod='shoppingfeed'}</a>.
    </div>
    {/if}
{/if}
