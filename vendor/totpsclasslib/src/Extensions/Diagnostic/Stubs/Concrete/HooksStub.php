...
use ShoppingfeedClasslib\Extensions\Diagnostic\Stubs\Handler\HooksStubHandler;
...
class HooksStub extends AbstractStub implements StubInterface
{
    ...
    {
        parent::__construct();
        $this->tpl = _PS_MODULE_DIR_ . 'shoppingfeed/views/templates/admin/diagnostic/hooks.tpl';
