...
use ShoppingfeedClasslib\Extensions\Diagnostic\Stubs\Handler\FileIntegrityStubHandler;
use ShoppingfeedClasslib\Extensions\Diagnostic\Stubs\Model\FileIntegrityParameters;
...
class FileIntegrityStub extends AbstractStub
{
    ...
    {
        parent::__construct();
        $this->tpl = _PS_MODULE_DIR_ . 'shoppingfeed/views/templates/admin/diagnostic/file_integrity.tpl';
