...
use ShoppingfeedClasslib\Extensions\Diagnostic\Stubs\Handler\GithubVersionHandler;
use ShoppingfeedClasslib\Extensions\Diagnostic\Stubs\Interfaces\StubInterface;
use ShoppingfeedClasslib\Extensions\Diagnostic\Stubs\Model\GithubVersionParameters;
...
class GithubVersionStub extends AbstractStub implements StubInterface
{
    ...
    {
        parent::__construct();
        $this->tpl = _PS_MODULE_DIR_ . 'shoppingfeed/views/templates/admin/diagnostic/github_version.tpl';
