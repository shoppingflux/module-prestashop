...
use ShoppingfeedClasslib\Extensions\Diagnostic\Stubs\Handler\LogsStubHandler;

/**
 * @include 'shoppingfeed/views/templates/admin/diagnostic/logs-content.tpl'
 */
class LogsStub extends AbstractStub
{
    ...
    {
        parent::__construct();
        $this->tpl = _PS_MODULE_DIR_ . 'shoppingfeed/views/templates/admin/diagnostic/logs.tpl';
