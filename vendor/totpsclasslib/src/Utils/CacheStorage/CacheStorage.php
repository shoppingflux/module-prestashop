...
namespace ShoppingfeedClasslib\Utils\CacheStorage;

use ShoppingfeedClasslib\Utils\CacheStorage\Exception\CacheException;
...
class CacheStorage
{
     ...
     * @var string
     */
    protected $directory = _PS_CACHE_DIR_ . 'shoppingfeed/';
    ...
    protected function createCacheDirectoriesIfNotExists()
    {
        ...
        $this->createCacheDirectory(_PS_CACHE_DIR_ . 'shoppingfeed/');
