...
if (!interface_exists(UriFactory::class)) {
    throw new \LogicException('You cannot use "ShoppingfeedPrefix\Http\Message\MessageFactory\SlimUriFactory" as the "php-http/message-factory" package is not installed. Try running "composer require php-http/message-factory". Note that this package is deprecated, use "psr/http-factory" instead');
}
