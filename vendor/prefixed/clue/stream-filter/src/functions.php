...
namespace ShoppingfeedPrefix\Clue\StreamFilter;
 ...
 *
 * ```php
 * $filter = ShoppingfeedPrefix\Clue\StreamFilter\append($stream, function ($chunk) {
 ...
 *
 * ```php
 * ShoppingfeedPrefix\Clue\StreamFilter\append($stream, 'strtoupper');
 *
 ...
 *
 * ```php
 * ShoppingfeedPrefix\Clue\StreamFilter\append($stream, function ($chunk = null) {
 *     if ($chunk === null) {
 ...
 *
 * ```php
 * ShoppingfeedPrefix\Clue\StreamFilter\append($stream, function ($chunk) {
 ...
 *
 * ```php
 * $filter = ShoppingfeedPrefix\Clue\StreamFilter\prepend($stream, function ($chunk) {
 *     // will be called each time you read or write a $chunk to/from the stream
 *     return $chunk;
 * });
 * ```
 ...
 *
 * ```php
 * $fun = ShoppingfeedPrefix\Clue\StreamFilter\fun('string.rot13');
 *
 ...
 *
 * ```php
 * ShoppingfeedPrefix\Clue\StreamFilter\fun('unknown'); // throws RuntimeException
 * ```
 *
 ...
 *
 * ```php
 * $fun = ShoppingfeedPrefix\Clue\StreamFilter\fun('string.strip_tags', '<a><b>');
 *
 * $ret = $fun('<b>h<br>i</b>');
 * assert('<b>hi</b>' === $ret);
 * ```
 ...
 *
 * ```php
 * $fun = ShoppingfeedPrefix\Clue\StreamFilter\fun('zlib.deflate');
 *
 ...
 *
 * ```php
 * $filter = ShoppingfeedPrefix\Clue\StreamFilter\append($stream, function () {
 *     // …
 * });
 * ShoppingfeedPrefix\Clue\StreamFilter\remove($filter);
 * ```
 *
